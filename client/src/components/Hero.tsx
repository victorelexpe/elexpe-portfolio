  ...
  return (
    ...
    >
      <div className="space-y-8 max-w-4xl mx-auto">
        <motion.h1 variants={fadeIn} className="text-hero text-center">
          Hi, I'm Victor Elexpe
        </motion.h1>
        <motion.p variants={fadeIn} className="text-subtitle text-center">
          Computer Engineer specializing in Data Engineering. I also do sim
          racing and produce music.
        </motion.p>
